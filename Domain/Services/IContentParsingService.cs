...
public interface IContentParsingService
{
    ...
    Task<(List<Guid> UserMentioned, List<int> Hashtags, int TotalPoints, string ParsedContent, List<string> NotFoundUsernames)> ParsePostContentAsync(string content, Guid companyId, Guid userId);
